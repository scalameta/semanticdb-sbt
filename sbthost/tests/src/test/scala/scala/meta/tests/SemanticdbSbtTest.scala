...
class ScalaFileTest extends SemanticdbSbtTest(BuildInfo.sourceroot, BuildInfo.targetroot) {
  checkNames(
    ...
    """Language:
      ...
      |[122..125): bar => _root_.sbthost.CompiledWithSbthost.bar(Int).
      |[126..127): x => _root_.sbthost.CompiledWithSbthost.bar(Int).(x)
      |[129..132): Int => _root_.scala.Int#
      |[136..137): x => _root_.sbthost.CompiledWithSbthost.bar(Int).(x)
      |[144..147): bar => _root_.sbthost.CompiledWithSbthost.bar(String).
      |[148..149): x => _root_.sbthost.CompiledWithSbthost.bar(String).(x)
      |[151..157): String => _root_.scala.Predef.String#
      |[161..162): x => _root_.sbthost.CompiledWithSbthost.bar(String).(x)
      |[165..168): bar => _root_.sbthost.CompiledWithSbthost.bar(Int).
      |[174..177): bar => _root_.sbthost.CompiledWithSbthost.bar(String).
      |[195..196): x => _root_.sbthost.CompiledWithSbthost.x.
      |[199..206): taskKey => _root_.sbt.package.taskKey(String).
...
class SbtFileTest extends SemanticdbSbtTest(BuildInfo.sbtSourceroot, BuildInfo.sbtTargetroot) {
  checkNames(
    ...
    """
      ...
      |[36..38): := => _root_.sbt.SettingKey#`:=`(T).
      |[47..48): + => _root_.java.lang.String#`+`(Any).
      |[49..52): foo => <>.foo().
      |[60..72): organization => _root_.sbt.Keys.organization().
      |[73..75): := => _root_.sbt.SettingKey#`:=`(T).
      |[103..104): + => _root_.java.lang.String#`+`(Any).
      |[105..108): foo => <>.foo().
      |[110..114): test => _root_.sbt.Keys.test().
      |[115..117): := => _root_.sbt.Scoped.DefinableTask#`:=`(S).
      |[118..121): Def => _root_.sbt.Def.
      |[122..126): task => _root_.sbt.Def.task(T).
      |[136..141): value => _root_.sbt.std.MacroValue#value().
      |""".stripMargin
  )
}
